...
import 'package:allenrealestateflutter/core/services/real_estate_service/implementations/heroku_server/parsers.dart'
    as parser;
...
class Service extends RealEstateService {
  static BaseOptions _options = BaseOptions(
    baseUrl:
        "https://allen-real-estate-rest.herokuapp.com/api/v1/real-estates/",
  ...
  Future<AsyncResult<List<RealEstateListItem>>> getPopularRealEstates(
    ...
    List<RealEstateListItem> _results =
        response.map((e) => parser.realEstateListItemFromMap(e)).toList();
  ...
  Future<AsyncResult<List<RealEstateListItem>>> getRealEstatesByQuery(
    ...
    Response raw = await _dio
        .get('/search?q=$query&page=$page&limit=$size',
